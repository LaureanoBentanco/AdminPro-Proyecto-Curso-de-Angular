...
export class DataService {
    ...
    cargarPersonas(){
        return this.httpClient.get('https://listado-personas-74cde-default-rtdb.firebaseio.com/.json');
    }

    //Guarda todo el arreglo de personas
    guardarPersonas(personas: Persona[]) {
        this.httpClient.put('https://listado-personas.firebaseio.com/datos.json', personas)
            .subscribe(
                (response) => {
